package com.nuryazid.wheelpicker.util;
...
public interface IWheelPicker {
     ...
     * {@link com.nuryazid.wheelpicker.util.WheelPicker.OnItemSelectedListener}回调监听或调用
     ...
     * through {@link com.nuryazid.wheelpicker.util.WheelPicker.OnItemSelectedListener} or call
     ...
     * 前所根据这些参数改变的一些属性，比如
     * {@link com.nuryazid.wheelpicker.util.OnWheelChangeListener}和
     * {@link com.nuryazid.wheelpicker.util.WheelPicker.OnItemSelectedListener}监听器中方法参数的值，因
     * 此你总该在调用该方法后考虑到相关影响
     ...
     * {@link com.nuryazid.wheelpicker.util.OnWheelChangeListener} and
     * {@link com.nuryazid.wheelpicker.util.WheelPicker.OnItemSelectedListener}, so you must always
     ...
     * @see com.nuryazid.wheelpicker.util.OnWheelChangeListener
     */
